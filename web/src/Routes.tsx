    ...
    <Router useAuth={useAuth}>
      ...
      <PrivateSet unauthenticated="login" role="admin">
        <Set wrap={AdminLayout}>
          ...
          <Route path="/admin/sale-note/{id:String}/add-payment" page={AdminAddPaymentToSaleNotePage} name="adminAddPaymentToSaleNote" />
          <Route path="/admin/sale-note/payment/{id:String}/edit" page={AdminEditSaleNotePaymentPage} name="adminEditSaleNotePayment" />
          {/* Reports routes */}
