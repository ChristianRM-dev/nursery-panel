...
import {
  ...
  TableConfig,
  TableQuery,
} from '../Shared/PaginatedTable/PaginatedTable.types'
...
import { PlantSelector } from './PlantCategorySelector'
...
const PlantsTable = () => {
  ...
  const config: TableConfig<(typeof plants)[0]> = {
    ...
    actions: [
      ...
      {
        type: TableActionType.CreateOrderTicket,
        icon: <IconTicket />,
        tooltip: 'Create Order Ticket',
      },
    ],
